...
public class AddUserToFamilyWithValidDataReturnsCreatedWithFamilyUser : AuthenticatedTestBase
{
    public AddUserToFamilyWithValidDataReturnsCreatedWithFamilyUser(CustomWebApplicationFactory factory)
        : base(factory)
    {
    }

    [Fact]
    public async Task AddUserToFamily_WithValidData_ReturnsCreatedWithFamilyUser()
    {
