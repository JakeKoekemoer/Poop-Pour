...
public class SaveSettingsAsyncWithChangesSavesAndLogs
{
    ...
    public SaveSettingsAsyncWithChangesSavesAndLogs()
    {
    ...
    [Fact]
    public async Task SaveSettingsAsync_WithChanges_SavesAndLogs()
    {
        // Arrange
