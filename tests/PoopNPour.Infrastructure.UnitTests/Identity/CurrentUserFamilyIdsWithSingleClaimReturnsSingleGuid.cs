...
public class CurrentUserFamilyIdsWithSingleClaimReturnsSingleGuid
{
    [Fact]
    public void FamilyIds_OneFamilyMemberClaim_ReturnsCollectionWithThatGuid()
    {
        var familyId = Guid.NewGuid();

        var claimsPrincipal = new ClaimsPrincipal(new ClaimsIdentity(
            [new Claim(DomainClaimTypes.FamilyMember, familyId.ToString())],
            "Test"));
