...
export interface AddFamilyFormValues {
  familyName: string
...
const emit = defineEmits<{
  submit: [values: AddFamilyFormValues]
  cancel: []
}>()

const form = useForm({
  validationSchema: toTypedSchema(addFamilySchema),
})
  ...
  <form @submit="onSubmit" class="space-y-4">
    ...
    <div class="flex gap-3 pt-2">
      <Button type="submit" :disabled="props.isSubmitting">
        {{ props.isSubmitting ? 'Creating Family...' : 'Create Family' }}
      </Button>
